---
title: "BioCapp: a web app for biodiversity and CO2 capture and avoided emissions estimation in cattle ranching landscapes of Colombia"
...
Sustainable Livestock, Carbon Capture, Biodiversity, R]
...
The application was developed using the 
    ...
    • R language and shiny for user interface
    • What relevant packages are used?
    • What important functions were developed
    • Include a schematic of the architecture of the application (user inputs, function calls, outputs).
    • How to install and where to access the app.
